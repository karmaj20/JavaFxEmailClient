...
public class EmailSenderService extends Service<EmailSendingResult> {
    ...
    public EmailSenderService(EmailAccount emailAccount, String subject, String recpient, String content, List<File> attachments) {
        ...
        return new Task<EmailSendingResult>() {
            ...
            protected EmailSendingResult call() {
                try {
                    ...
                    mimeMessage.addRecipients(Message.RecipientType.TO, recpient);
