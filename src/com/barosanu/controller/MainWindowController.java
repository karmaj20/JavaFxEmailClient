...
public class MainWindowController extends BaseController implements Initializable {
    ...
    @FXML
    private TableView<EmailMessage> emailsTablesView;
    ...
    private void setUpMessageSelection() {
        emailsTablesView.setOnMouseClicked(event -> {
            EmailMessage emailMessage = emailsTablesView.getSelectionModel().getSelectedItem();
    ...
    private void setUpBoldRows() {
        emailsTablesView.setRowFactory(new Callback<TableView<EmailMessage>, TableRow<EmailMessage>>() {
            @Override
    ...
    private void setUpFolderSelection() {
        emailTreeView.setOnMouseClicked(e->{
            ...
            if(item != null) {
                ...
                emailsTablesView.setItems(item.getEmailMessages());
            }
        });
    }
    ...
    private void setUpEmailsTableView() {
        ...
        emailsTablesView.setContextMenu(new ContextMenu(markUnreadMenuItem, deleteMessageMenuItem, showMessageDetailsMenuItem));
    }
